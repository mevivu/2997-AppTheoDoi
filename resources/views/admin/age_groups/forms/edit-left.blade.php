        ...
        <div class="row card-body">
            ...
            <div class="col-md-6 col-12">
                <div class="mb-3">
                    ...
                    <x-input type="number" name="min_months" :value="old('min_months', $instance->min_months)" min="0" placeholder="Để trống nếu là Thai giáo" />
            ...
            <div class="col-md-6 col-12">
                <div class="mb-3">
                    ...
                    <x-input type="number" name="max_months" :value="old('max_months', $instance->max_months)" min="0" placeholder="Để trống nếu là Thai giáo hoặc không giới hạn (14+)" />
