            ...
            <div class="row g-3">
                <div class="col-12 col-md-5">
                    <div class="mb-3">
                        ...
                        <x-input type="text" name="name" :value="old('name')" :required="true" placeholder="{{ __('Ví dụ: Phương tiện giao thông (Xe)') }}" />
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="mb-3">
                        ...
                        <x-input type="text" name="code" :value="old('code')" :required="true" placeholder="{{ __('ví dụ: vehicles, flowers, numbers, flags') }}" />
                ...
                <div class="col-12 col-md-3">
                    <div class="mb-3">
                        ...
                        <x-input type="number" name="age" :value="old('age', 1)" min="1" max="20" :required="true" placeholder="1" />
                ...
                <div class="col-12 col-md-6">
                    <div class="mb-3">
                        ...
                        <x-input-image name="icon" :value="old('icon')" sub="{{ __('Ảnh icon hoặc biểu tượng của chủ đề (khuyến nghị vuông 1:1, tối đa 5MB)') }}" />
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="mb-3">
                        ...
                        <textarea name="description" class="form-control" rows="3" placeholder="{{ __('Nhập mô tả ngắn gọn về chủ đề này...') }}">{{ old('description') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
