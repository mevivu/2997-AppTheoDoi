            ...
            <div class="row g-3">
                <div class="col-12">
                    <div class="mb-3">
                        ...
                        <x-input type="text" name="name" :value="old('name')" :required="true" placeholder="{{ __('Ví dụ: Mầm non (3 - 5 tuổi) - Lưới 2x3') }}" />
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6">
                    <div class="mb-3">
                        ...
                        <x-input type="number" name="min_age" :value="old('min_age', 3)" min="1" max="25" :required="true" />
                ...
                <div class="col-12 col-md-6">
                    <div class="mb-3">
                        ...
                        <x-input type="number" name="max_age" :value="old('max_age', 5)" min="1" max="25" :required="true" />
                    ...
                    <div class="card bg-light border p-3">
                        ...
                        <div class="row g-3 align-items-center">
                            <div class="col-12 col-md-4">
                                ...
                                <input type="number" name="rows" id="inputRows" class="form-control" value="{{ old('rows', 2) }}" min="2" max="10" required>
                            </div>
                            <div class="col-12 col-md-4">
                                <label class="form-label fw-bold">{{ __('Số cột (Columns)') }}: <span class="text-danger">*</span></label>
                                <input type="number" name="columns" id="inputCols" class="form-control" value="{{ old('columns', 3) }}" min="2" max="10" required>
                            </div>
                            <div class="col-12 col-md-4">
                ...
                <div class="col-12 col-md-4">
                    <div class="mb-3">
                        ...
                        <x-input type="number" name="total_duration" :value="old('total_duration', 180)" min="30" max="600" :required="true" />
                        <small class="text-muted fs-12">{{ __('Mặc định 180s (03 phút/bài test)') }}</small>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="mb-3">
                        ...
                        <x-input type="number" name="total_rounds" :value="old('total_rounds', 3)" min="1" max="10" :required="true" />
                        <small class="text-muted fs-12">{{ __('Mặc định 03 lượt game liên tiếp') }}</small>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="mb-3">
                        ...
                        <x-input type="number" name="peek_time" :value="old('peek_time', 3)" min="0" max="30" />
