            ...
            <div class="row g-3 align-items-center">
                <div class="col-12 col-md-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="rows" id="inputRows" class="form-control fw-bold" value="{{ $response->rows }}" min="2" max="10" required>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="columns" id="inputCols" class="form-control fw-bold" value="{{ $response->columns }}" min="2" max="10" required>
                    </div>
                </div>
