        ...
        <div class="card-body">
            ...
            <div class="mt-4 pt-3 border-top">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-2">
                    ...
                    @php
                        $currMistakes = (int) old('max_mistakes', $response->max_mistakes ?? 0);
                    @endphp
                    <span id="mistakesConvertedBadge" class="badge {{ $currMistakes > 0 ? 'bg-danger-lt text-danger' : 'bg-secondary-lt text-secondary' }} px-2 py-1 fs-12 fw-semibold">
                        {{ $currMistakes > 0 ? __('Tối đa :count lần sai / ván', ['count' => $currMistakes]) : __('Không giới hạn') }}
                    </span>
                </div>
                ...
                <div class="row align-items-center g-2">
                    <div class="col-12 col-sm-6 col-md-4">
                        <div class="input-group">
                            ...
                            <input type="number" name="max_mistakes" id="inputMaxMistakes" class="form-control fw-bold" value="{{ $currMistakes }}" min="0" max="100">
