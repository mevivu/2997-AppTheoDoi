        ...
        <div class="card-body">
            ...
            <div class="mt-4 pt-3 border-top">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-2">
                    ...
                    @php
                        $currMoves = (int) old('max_moves', $response->max_moves ?? 0);
                    @endphp
                    <span id="movesConvertedBadge" class="badge {{ $currMoves > 0 ? 'bg-warning-lt text-warning-emphasis' : 'bg-secondary-lt text-secondary' }} px-2 py-1 fs-12 fw-semibold">
                        {{ $currMoves > 0 ? __('Tối đa :count lượt mở / ván', ['count' => $currMoves]) : __('Không giới hạn') }}
                    </span>
                </div>
                ...
                <div class="row align-items-center g-2">
                    <div class="col-12 col-sm-6 col-md-4">
                        <div class="input-group">
                            ...
                            <input type="number" name="max_moves" id="inputMaxMoves" class="form-control fw-bold" value="{{ $currMoves }}" min="0" max="300">
