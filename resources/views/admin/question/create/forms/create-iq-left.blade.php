                ...
                <div class="mb-3">
                    ...
                    <x-select name="question[question_group_id]" :required="true">
                        ...
                        @foreach ($questionGroups as $key => $value)
                            <x-select-option :value="$key" :title="$value" :selected="old('question.question_group_id') == $key" />
                        @endforeach
                    </x-select>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <textarea 
                        ...
                        required 
                        maxlength="2000"
                        placeholder="{{ __('Nhập nội dung câu hỏi trắc nghiệm...') }}" 
                        style="min-height: 100px; resize: vertical; line-height: 1.55; font-size: 14px;">{{ old('question.question') }}</textarea>
