    ...
    <div class="card border-0 custom-shadow rounded-3 mb-4">
        <div class="card-header bg-white border-bottom py-3 px-4 d-flex align-items-center justify-content-between">
            <div class="d-flex align-items-center gap-3">
                <span class="avatar avatar-md rounded-circle" id="header_source_icon" style="background: #fee2e2; color: #dc2626; width: 48px; height: 48px;">
                    <i class="ti ti-brand-youtube fs-2"></i>
                </span>
                <div>
                    <h4 class="mb-1 fw-bold text-dark fs-19">{{ __('Nguồn Video & Xem trước') }}</h4>
                    <span class="text-secondary fs-15" id="header_source_desc">{{ __('Hỗ trợ liên kết YouTube hoặc tải file video trực tiếp lên Cloudflare R2 (tối đa 200MB)') }}</span>
                </div>
            </div>
            <span id="source_status_pill" class="badge bg-secondary-lt fs-14 px-3 py-2 fw-semibold">
                <i class="ti ti-link"></i> {{ __('Chờ nhập video') }}
            </span>
        </div>
        ...
        <div class="card-body p-4">
            ...
            <div class="row g-3 mb-4">
                <div class="col-sm-6 col-12">
                    <label class="form-selectgroup-item w-100 cursor-pointer" onclick="window.switchVideoSource('youtube')">
                        <input type="radio" name="video_type" value="youtube" class="form-selectgroup-input video-source-radio" {{ old('video_type', 'youtube') === 'youtube' ? 'checked' : '' }} onchange="window.switchVideoSource('youtube')">
                        <div id="card_source_youtube" class="form-selectgroup-label d-flex align-items-center p-3 border rounded-3 text-start transition-all cursor-pointer" style="min-height: 84px;">
                            ...
                            <div class="flex-fill">
                                ...
                                <div class="text-secondary fs-14 lh-sm">{{ __('Nhập link video, tự động đo thời lượng & lấy ảnh thu nhỏ.') }}</div>
                            </div>
                        </div>
                    </label>
                </div>
                <div class="col-sm-6 col-12">
                    <label class="form-selectgroup-item w-100 cursor-pointer" onclick="window.switchVideoSource('r2')">
                        <input type="radio" name="video_type" value="r2" class="form-selectgroup-input video-source-radio" {{ old('video_type') === 'r2' ? 'checked' : '' }} onchange="window.switchVideoSource('r2')">
                        <div id="card_source_r2" class="form-selectgroup-label d-flex align-items-center p-3 border rounded-3 text-start transition-all cursor-pointer" style="min-height: 84px;">
                            ...
                            <div class="flex-fill">
                                ...
                                <div class="text-secondary fs-14 lh-sm">{{ __('Tải video trực tiếp từ máy tính, phát riêng tư & bảo mật.') }}</div>
                            </div>
                        </div>
                    </label>
                </div>
            ...
            {{-- 1. SECTION YOUTUBE --}}
            <div id="section_youtube_wrapper">
                <div class="mb-3">
                    ...
                    <div class="yt-link-input-wrapper">
                        ...
                        <button class="yt-btn-clear" type="button" id="btn_clear_yt" title="{{ __('Xóa link') }}" style="display: none;">
                            <i class="ti ti-x fs-18"></i>
                        </button>
                        <button class="btn-yt-fetch" type="button" id="btn_fetch_yt" title="{{ __('Lấy thông tin tự động') }}">
                ...
                <div id="yt_preview_container" class="rounded-3 border overflow-hidden mt-3 shadow-sm" style="display: none; background: #0f172a;">
                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                            <div class="d-flex flex-wrap align-items-center gap-2">
                                ...
                                <span class="badge bg-light text-dark border fs-13 px-2 py-1">
                                    ID: <code class="text-danger fw-bold fs-13" id="yt_meta_id">—</code>
                                </span>
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <a href="#" target="_blank" rel="noopener noreferrer" class="btn btn-sm btn-outline-danger d-flex align-items-center gap-1 fs-13 px-3 py-1" id="btn_watch_external">
            ...
            <div id="section_r2_wrapper" style="display: none;">
                <div class="mb-3">
                    <label class="form-label fw-bold fs-17 mb-2 text-dark" for="r2_video_file">
                        {{ __('Chọn tệp Video tải lên') }}: <span class="text-danger">*</span>
                    </label>
                    ...
                    <div id="r2_dropzone" class="r2-dropzone-box text-center cursor-pointer shadow-sm">
                        ...
                        <div id="r2_dropzone_default">
                            ...
                            <h3 class="fw-bold mb-2 text-dark r2-dropzone-title">
                                {{ __('Kéo & thả video vào đây hoặc nhấn để chọn tệp') }}
                            </h3>
                        ...
                        <div id="r2_file_info_card" class="bg-white border rounded-3 p-3 text-start shadow-sm mt-2" style="display: none;">
                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <button type="button" class="btn btn-outline-danger fs-14 px-3 py-2 fw-semibold" id="btn_remove_r2_file" title="{{ __('Bỏ chọn tệp') }}">
                ...
                {{-- Live HTML5 Video Preview Box --}}
                <div id="r2_preview_container" class="rounded-3 border overflow-hidden mt-3 shadow-sm" style="display: none; background: #0f172a;">
                    <div class="position-relative" style="padding-top: 56.25%; background: #000;">
                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                            <div class="d-flex flex-wrap align-items-center gap-2">
                                ...
                                <span class="badge bg-success-lt text-success border border-success fs-13 px-3 py-1 fw-bold d-flex align-items-center gap-1" id="r2_meta_duration_pill">
                                    <i class="ti ti-clock"></i>
                                    <span id="r2_meta_duration_text">⏱️ 00:00</span>
                                </span>
                            ...
                            <div>
                                <span class="text-success fs-13 fw-semibold"><i class="ti ti-sparkles text-success me-1"></i>{{ __('Đã tự động tính thời lượng từ tệp video') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="duration-digital-box">
                                    ...
                                    <div>
                                        ...
                                        <div class="d-flex align-items-baseline gap-2">
                                            <span id="duration_formatted_badge" class="duration-digits">00:00</span>
                                            <span id="duration_total_seconds_badge" class="badge bg-light text-secondary border fs-12 px-2 py-1 fw-bold">0s</span>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    window.switchVideoSource = function(type) {
        ...
        if (type === 'r2') {
            ...
            if (headerSourceDesc) {
                headerSourceDesc.textContent = 'Tải file video trực tiếp lên Cloudflare R2 (tối đa 200MB)';
            }
            if (sourceStatusPill) {
                sourceStatusPill.className = 'badge bg-orange text-white fs-13 px-3 py-2 fw-semibold';
                sourceStatusPill.innerHTML = '<i class="ti ti-cloud"></i> Cloudflare R2 (200MB)';
            }
            ...
            if (headerSourceDesc) {
                headerSourceDesc.textContent = 'Nhập link YouTube để hệ thống tự động nhận diện video và thời lượng';
            }
            if (sourceStatusPill) {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function handleR2File(file) {
            ...
            if (inputTitle && (!inputTitle.value.trim() || inputTitle.dataset.autoYt === 'true')) {
                const cleanName = file.name.replace(/\.[^/.]+$/, "").replace(/[-_]/g, ' ');
                inputTitle.value = cleanName;
                inputTitle.dataset.autoYt = 'false';
                updateTitleCounter();
                highlightTitleField();
            }
