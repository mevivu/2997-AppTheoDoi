<div class="col-12 col-lg-8">
    ...
    <div class="card border-0 custom-shadow rounded-3 mb-4">
        <div class="card-header bg-white border-bottom py-3 px-4 d-flex align-items-center justify-content-between">
            <div class="d-flex align-items-center gap-2">
                ...
                <div>
                    ...
                    <small class="text-muted">{{ __('Hệ thống tự động phát hiện YouTube ID và tính toán thời lượng video') }}</small>
                </div>
            </div>
            <span id="yt_status_pill" class="badge bg-success fs-12 px-2 py-1">
                <i class="ti ti-check"></i> {{ __('Đã nhận diện') }}
            </span>
        </div>
        ...
        <div class="card-body p-4">
            ...
            <div class="mb-3">
                ...
                <div class="input-group input-group-flat shadow-none">
                    ...
                    <input type="text"
                           ...
                           value="{{ old('video_url', $instance->video_url) }}"
                           required
                           autocomplete="off"
                           inputmode="url"
                           aria-describedby="youtube_url_help youtube_url_error" />
                    <button class="btn btn-outline-secondary px-3" type="button" id="btn_clear_yt" title="{{ __('Xóa link') }}">
                        <i class="ti ti-x"></i>
                    </button>
                    <button class="btn btn-danger px-3 d-flex align-items-center gap-1" type="button" id="btn_fetch_yt" title="{{ __('Nhận diện lại') }}">
            ...
            <div id="yt_preview_container" class="rounded-3 border overflow-hidden mt-3" style="background: #0f172a;">
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                        <div class="d-flex flex-wrap align-items-center gap-2">
                            ...
                            <span class="badge bg-light text-dark border fs-12 px-2 py-1">
                                ID: <code class="text-danger fw-bold" id="yt_meta_id">{{ $instance->youtube_id ?? '—' }}</code>
                            </span>
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <a href="{{ $instance->video_url }}" target="_blank" rel="noopener noreferrer" class="btn btn-sm btn-outline-danger d-flex align-items-center gap-1" id="btn_watch_external">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6 col-12">
                    <label class="form-label fw-bold d-flex justify-content-between align-items-center" for="duration_seconds">
                        ...
                        <span class="badge bg-blue-lt fs-11" id="duration_formatted_badge">{{ $instance->formatted_duration }}</span>
                    </label>
                        ...
                        <div class="mt-2 pt-2 border-top d-flex align-items-center justify-content-between">
                            ...
                            <div class="d-flex align-items-center gap-1" style="max-width: 140px;">
                                <input type="number"
                                       ...
                                       min="0"
                                       value="{{ old('duration_seconds', $instance->duration_seconds) }}" />
                ...
                <div class="col-md-6 col-12">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number"
                               ...
                               min="0"
                               value="{{ old('sort_order', $instance->sort_order) }}" />
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Pre-fetch in background if existing URL is present on edit page
