<div class="card h-100">
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="time" 
                            name="bike_C_Ride_morning_start" 
                            class="form-control" 
                            id="bike_C_Ride_morning_start"
                            value="{{ $bikeC_Ride_Rush_Hour['bike_C_Ride_morning_start'] }}">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="time" 
                            name="bike_C_Ride_morning_end" 
                            class="form-control" 
                            id="bike_C_Ride_morning_end"
                            value="{{ $bikeC_Ride_Rush_Hour['bike_C_Ride_morning_end'] }}">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="time" 
                            name="bike_C_Ride_afternoon_start" 
                            class="form-control" 
                            id="bike_C_Ride_afternoon_start"
                            value="{{ $bikeC_Ride_Rush_Hour['bike_C_Ride_afternoon_start'] }}">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="time" 
                            name="bike_C_Ride_afternoon_end" 
                            class="form-control" 
                            id="bike_C_Ride_afternoon_end"
                            value="{{ $bikeC_Ride_Rush_Hour['bike_C_Ride_afternoon_end'] }}">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card mb-3">
        ...
        <div class="row card-body">
            ...
            <div class="setRatePerKmDiv">
                ...
                <div class="col-12">
                    <div class="mb-3">
                        ...
                        <x-input :value="$bikeC_Ride_Settings['bike_C_Ride_base_distance']"
                                 id="bike_C_Ride_base_distance_input"
                                 type="number"
                                 min=0
                                 required
                                 name="bike_C_Ride_base_distance"
                                 placeholder="{{ __('Đơn vị Km') }}" />
                    </div>
                </div>

                <!-- bike_C_Ride_base_fare -->
                <div class="col-12">
                    <div class="mb-3">
                        ...
                        <x-input-price name="bike_C_Ride_base_fare"
                            id="bike_C_Ride_base_fare"
                            :value="$bikeC_Ride_Settings['bike_C_Ride_base_fare']"
                            :required="true"
            ...
            <div class="setRatePerKmDiv">
                <!-- bike_C_Ride_distance_to_discount -->
                <div class="col-12">
                    <div class="mb-3">
                        <label class="control-label text-danger">
                        ...
                        <p class="fst-italic">
                            Quãng đường sau km thứ <span class="fw-bold"
                                                         id="bike_C_Ride_base_distance_text">
                                {{ $bikeC_Ride_Settings['bike_C_Ride_base_distance'] }}
                            </span> đến hết km thứ
                        </p>
                        <x-input :value="$bikeC_Ride_Settings['bike_C_Ride_distance_to_discount']"
                                 type="number"
                                 min=0
                                 required
                                 id="bike_C_Ride_distance_to_discount_input"
                                 name="bike_C_Ride_distance_to_discount"
                                 placeholder="{{ __('Đơn vị Km') }}" />
                    </div>
                </div>

                <!-- bike_C_Ride_rate_per_km -->
                <div class="col-12">
                    <div class="mb-3">
                        <label class="control-label text-success">{{ __('... thì sẽ có giá / 1 km (VNĐ) là') }}:</label>
                        <p class="fst-italic">Dùng để tính giá tài xế xử lý đơn. </p>

                        <x-input-price name="bike_C_Ride_rate_per_km"
                            id="bike_C_Ride_rate_per_km"
                            :value="$bikeC_Ride_Settings['bike_C_Ride_rate_per_km']"
                            :required="true"
                            :placeholder="__('Ví dụ: 20000')"/>
                    </div>
                </div>
            ...
            <div class="setRatePerKmDiv">
                <!-- bike_C_Ride_rate_per_km_discount -->
                <div class="col-12">
                    <div class="mb-3">
                        <p class="fst-italic">Quãng đường sau km thứ
                            <span class="fw-bold" id="bike_C_Ride_distance_to_discount_text">{{  $bikeC_Ride_Settings['bike_C_Ride_distance_to_discount'] }}</span>
                        </p>
                        <label class="control-label text-success">{{ __('... thì sẽ có giá / 1 km (VNĐ) là') }}:</label>

                        <x-input-price name="bike_C_Ride_rate_per_km_discount"
                            id="bike_C_Ride_rate_per_km_discount"
                            :value="$bikeC_Ride_Settings['bike_C_Ride_rate_per_km_discount']"
                            :required="true"
                            :placeholder="__('Ví dụ: 20000')"/>
                    </div>
                </div>
