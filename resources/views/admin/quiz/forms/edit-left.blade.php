        ...
        <div class="row card-body">
            ...
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <x-input type="text" name="title" :value="$instance->title" :required="true" :placeholder="__('title')" />
                </div>
            </div>
            @if ($instance->type == \App\Enums\Question\QuestionType::IQ->value)
                ...
                <div class="col-12">
                    <div class="mb-3">
                        ...
                        <x-input type="text" name="age" :value="$instance->age" :required="true" :placeholder="__('age')" />
                    </div>
                </div>
            @endif
            ...
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <textarea name="description" class="form-control" rows="4" placeholder="{{ __('description') }}">{{ $instance->description }}</textarea>
                </div>
            </div>
