...
class RoleController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        if ($response->guard_name == 'web') {
            $permissions = $this->repository->getAllPermissionsNoModule(PermissionType::USER->value);
            $listPermissionsInAllModules = $this->repository->getAllPermissionsInAllModules(PermissionType::USER->value);
        } else {
