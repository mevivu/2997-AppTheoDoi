...
class QuestionEqAqRequest extends BaseRequest
{
    protected function methodPost(): array
    {
        $rules = [
            ...
            'question.question' => 'required|string|max:2000',
    ...
    public function messages(): array
    {
        return [
            ...
            'question.question.required' => 'Nội dung câu hỏi không được để trống',
            'question.question.max' => 'Nội dung câu hỏi không được vượt quá 2000 ký tự',
            'question.age_group.required' => 'Nhóm tuổi không được để trống',
